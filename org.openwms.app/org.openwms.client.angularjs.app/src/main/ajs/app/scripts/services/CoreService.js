...
define([
	...
	radio('core_mod').subscribe(function(evt, module, app) {
		if (evt === 'LOAD_ALL_SERVICES') {
			app.service('CoreService', ['$http', '$q', function ($http, $q) {
			...
			radio('core_mod').broadcast('ALL_SERVICES_LOADED', module);
		}
	});
});