...
package org.openwms.web.flex.client.tms.command
{
    ...
    /**
     * A CreateTransportOrderCommand.
     *
     * @author <a href="mailto:openwms@googlemail.com">Heiko Scherrer</a>
     * @version $Revision: 700 $
     */
    public class CreateTransportOrderCommand implements ICommand, IResponder
    {
        [Bindable]
        private var modelLocator:TMSModelLocator = TMSModelLocator.getInstance();

        public function CreateTransportOrderCommand()
        {
            super();
        }
        ...
        public function execute(event:CairngormEvent):void
        {
            ...
            delegate.createTransportOrder(event.data as TransportOrder);
        }

        public function result(data:Object):void
        {
            trace("TransportOrder created:"+data as TransportOrder);
        }
