...
package org.openwms.web.flex.client.common.command
{
    ...
    /**
     * A DeleteTransportUnitTypeCommand.
     *
     * @author <a href="mailto:openwms@googlemail.com">Heiko Scherrer</a>
     * @version $Revision: 700 $
     */
    public class DeleteTransportUnitTypeCommand implements IResponder, ICommand
    {

        public function DeleteTransportUnitTypeCommand()
        {
            super();
        }
        ...
        public function execute(event:CairngormEvent):void
        {
            ...
            delegate.deleteTransportUnitTypes(event.data as ArrayCollection);
        }
