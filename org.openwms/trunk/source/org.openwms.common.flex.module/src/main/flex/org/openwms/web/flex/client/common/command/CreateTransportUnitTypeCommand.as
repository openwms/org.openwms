...
package org.openwms.web.flex.client.common.command
{
    ...
    /**
     * A CreateTransportUnitTypeCommand.
     *
     * @author <a href="mailto:openwms@googlemail.com">Heiko Scherrer</a>
     * @version $Revision: 700 $
     */
    public class CreateTransportUnitTypeCommand implements IResponder, ICommand
    {

        public function CreateTransportUnitTypeCommand()
        {
            super();
        }
        ...
        public function fault(info:Object):void
        {
            ...
            Alert.show("Could not create a Transport Unit Type");
        }

        public function execute(event:CairngormEvent):void
        {
            var delegate:TransportUnitTypeDelegate = new TransportUnitTypeDelegate(this)
            delegate.createTransportUnitType(event.data as TransportUnitType);
        }
