...
package org.openwms.web.flex.client.common.command
{
    ...
    /**
     * A DeleteTransportUnitCommand.
     *
     * @author <a href="mailto:openwms@googlemail.com">Heiko Scherrer</a>
     * @version $Revision: 700 $
     */
    public class DeleteTransportUnitCommand implements IResponder, ICommand
    {

        public function DeleteTransportUnitCommand()
        {
            super();
        }
        ...
        public function fault(info:Object):void
        {
            ...
            trace("LOG:"+fault.toString());
            Alert.show("Could not delete TransportUnit");
        }
        ...
        public function execute(event:CairngormEvent):void
        {
        	if (event.data == null)
        	{
        		Alert.show("Please select a TransportUnit first");
        		return;
        	}
            var delegate:TransportUnitDelegate = new TransportUnitDelegate(this)
            delegate.deleteTransportUnits(event.data as ArrayCollection);
        }
