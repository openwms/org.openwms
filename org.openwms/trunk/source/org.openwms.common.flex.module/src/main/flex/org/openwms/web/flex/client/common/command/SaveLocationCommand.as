...
package org.openwms.web.flex.client.common.command
{
    ...
    /**
     * A SaveLocationCommand.
     *
     * @author <a href="mailto:openwms@googlemail.com">Heiko Scherrer</a>
     * @version $Revision: 700 $
     */
    public class SaveLocationCommand implements IResponder, ICommand
    {

        public function SaveLocationCommand()
        {
            super();
        }
        ...
        {
            Alert.show("Could not save the Location");
        }

        public function execute(event:CairngormEvent):void
        {
            var delegate:LocationDelegate = new LocationDelegate(this)
            delegate.saveLocation(event.data as Location);
        }
