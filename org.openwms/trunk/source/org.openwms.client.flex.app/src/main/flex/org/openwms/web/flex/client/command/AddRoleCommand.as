...
package org.openwms.web.flex.client.command {
     ...
     */
    public class AddRoleCommand extends AbstractCommand implements ICommand, IResponder {

        public function AddRoleCommand() {
            super();
        }

        public function execute(event : CairngormEvent) : void {
            if (event.data is Role) {
                new RoleDelegate(this).addRole(event.data as Role);
            }
        }

        public function result(data : Object) : void {
            var role : Role = Role(data.result);
        ...
        public function fault(event : Object) : void {
            ...
            Alert.show("Could not create Role");
        }
