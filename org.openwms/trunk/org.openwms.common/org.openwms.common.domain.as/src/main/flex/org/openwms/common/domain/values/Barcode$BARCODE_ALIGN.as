...
package org.openwms.common.domain.values {
    ...
    /**
     * A Barcode$BARCODE_ALIGN defines how a <code>Barcode</code> is aligned.
     *
     * @version $Revision$
     * @since 0.1
     * @see org.openwms.common.domain.values.Barcode
     */
    public class Barcode$BARCODE_ALIGN extends Enum {
        ...
        /**
         * Get all defined Barcode$BARCODE_ALIGN.
         *
         * @return an Array of Barcode$BARCODE_ALIGN
         */
         ...
         *
         * @param name
         * @return the Barcode$BARCODE_ALIGN
         */
