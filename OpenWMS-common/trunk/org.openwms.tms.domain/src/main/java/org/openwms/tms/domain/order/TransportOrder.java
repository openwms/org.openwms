...
public class TransportOrder implements Serializable {
	 ...
	 * The priority level affects the execution of the <tt>TransportOrder</tt>. A high priored order will be
	 * processed faster than lower ones.
	 */
	...
	/**
	 * A <tt>LocationGroup</tt> can also set as target. When the <tt>TransportOrder</tt> will be started, a target
	 * must be set.
	 */
	@ManyToOne
