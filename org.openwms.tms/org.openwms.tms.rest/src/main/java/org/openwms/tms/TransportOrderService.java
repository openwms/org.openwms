...
public interface TransportOrderService<T extends TransportOrder> {
     ...
     *
     * @param locationGroup {@link LocationGroup} to count all active transports for
     ...
     *
     * @param barcode The {@link Barcode} of the <tt>TransportUnit</tt>
     * @param targetLocationGroup The target {@link LocationGroup}
     ...
     *
     * @param transportOrders The IDs of {@link TransportOrder}s
     ...
     *
     * @param transportOrders The IDs of {@link TransportOrder}s to be redirected
     * @param targetLocationGroup The new target {@link LocationGroup} for the {@link TransportOrder}s or <code>null</code>
     * @param targetLocation The new target {@link Location} for the {@link TransportOrder} s, or <code>null</code>
