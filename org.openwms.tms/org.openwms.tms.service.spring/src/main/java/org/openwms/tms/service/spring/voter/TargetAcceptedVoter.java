...
/**
 * A TargetAcceptedVoter votes for a {@link RedirectVote} whether the target location or the target locationGroup is enabled for infeed. The
 * class is lazy initialized.
 * 
