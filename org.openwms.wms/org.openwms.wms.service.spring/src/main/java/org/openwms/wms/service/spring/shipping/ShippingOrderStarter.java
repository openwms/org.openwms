...
import org.openwms.wms.domain.shipping.ShippingOrderPositionSplit;
...
@Service(value = ShippingOrderStarter.COMPONENT_NAME)
public class ShippingOrderStarter implements EventListener, ApplicationListener<RootApplicationEvent> {
