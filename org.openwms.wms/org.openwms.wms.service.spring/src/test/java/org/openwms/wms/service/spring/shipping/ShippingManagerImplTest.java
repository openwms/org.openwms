...
public class ShippingManagerImplTest extends AbstractJpaSpringContextTests {
    ...
    @Autowired
    @Qualifier(ShippingManagerImpl.COMPONENT_NAME)
    ...
    /**
     * Test method for
     * {@link org.openwms.wms.service.spring.shipping.ShippingManagerImpl#createOrder(org.openwms.wms.domain.shipping.ShippingOrder)}
     * .
     * 
