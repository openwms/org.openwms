...
public class ReceivingManagerImplTest extends AbstractJpaSpringContextTests {
    ...
    @Autowired
    @Qualifier(ReceivingManagerImpl.COMPONENT_NAME)
    ...
    /**
     * Test method for
     * {@link org.openwms.wms.service.spring.receiving.ReceivingManagerImpl#create(org.openwms.wms.domain.order.OrderPositionKey, java.lang.String, org.openwms.core.domain.values.Unit, java.lang.String)}
     * .
     */
    @Test
    ...
    /**
     * Positive test to create a ReceivingOrder. Tests Cascade persist opertion
     * of orderPositons.
     */
    @Test
