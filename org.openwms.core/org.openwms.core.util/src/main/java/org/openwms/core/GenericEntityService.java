...
public interface GenericEntityService<T extends AbstractEntity, ID extends Serializable, BK extends Serializable> {
     ...
     * 
     * @param key
     *            The business key to identify the entity
     * @return The entity
     */
    T findByBK(BK key);
    ...
    /**
     * Update the given entity or persist it, in case it is a transient one.
     * 
     * @param entity
     *            Entity to save
     ...
     * 
     * @param keys
     *            The unique business keys of the entities to remove
     */
     ...
     * 
     * @param keys
     *            The unique technical keys of the entities to remove
     */
